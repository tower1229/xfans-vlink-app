    ...
    <ProtectedRoute>
      <div className="flex h-screen bg-gray-100">
        ...
        <div className="bg-white shadow-md w-64">
          <div className="p-6">
            <h1 className="bg-linear-to-r bg-clip-text font-bold from-purple-600 to-pink-600 text-transparent text-2xl">
              X-Fans
            </h1>
            {user && (
          ...
          <div className="p-6 bottom-0 w-64 absolute">
            <button
              onClick={handleLogout}
              className="flex text-gray-600 items-center hover:text-gray-800"
            >
              <svg
