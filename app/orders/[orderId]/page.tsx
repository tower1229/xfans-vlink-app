                ...
                {loading ? (
                    ...
                    <div className="p-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-medium text-gray-900">{formatDate(order.expiresAt)}</p>
                                    </div>
                                    <div>
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg">
                                <h2 className="text-lg font-medium text-gray-900 mb-4">区块链信息</h2>
                                <div className="space-y-3">
                                    <div>
                                        <p className="text-sm text-gray-500">用户地址</p>
                                        <p className="text-sm font-medium text-gray-900 break-all">{order.userAddress}</p>
                                    </div>
                                    <div>
                                        <p className="text-sm text-gray-500">所有者地址</p>
                                        <p className="text-sm font-medium text-gray-900 break-all">{order.ownerAddress}</p>
                                    </div>
                                    <div>
                                        <p className="text-sm text-gray-500">代币地址</p>
                                        <p className="text-sm font-medium text-gray-900 break-all">{order.tokenAddress}</p>
                                    </div>
                                    <div>
                                        <p className="text-sm text-gray-500">链 ID</p>
                                        <p className="text-sm font-medium text-gray-900">{order.chainId}</p>
                                    </div>
                                    {order.transactionHash && (
                                        <div>
                                            <p className="text-sm text-gray-500">交易哈希</p>
                                            <p className="text-sm font-medium text-gray-900 break-all">{order.transactionHash}</p>
                                        </div>
                                    )}
                                </div>
                            </div>
